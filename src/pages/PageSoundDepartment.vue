<template>
  <q-page class="q-pa-sm">
    <div class="q-pa-md absolute full-width full-height column">
      <h4 class="q-mt-none q-pt-sm">Sound Department</h4>
...
import AddMeeting from "../components/SoundDepartment/AddMeeting";
import EditMeeting from "../components/SoundDepartment/EditMeeting";
export default {
  ...
  computed: {
    ...mapGetters("soundDepartment", ["meetingsSorted"])
  },
  methods: {
