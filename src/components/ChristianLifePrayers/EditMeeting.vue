<template>
  <q-card>
    <q-card-section class="row">
      <div class="text-h6">Edit Christian Life Meeting Prayers</div>
      <q-space />
    ...
    <template v-else>
      <q-card-section>
        ...
        Go to Publishers's list and enable at least one publisher for this
        assignment
      </q-card-section>
    </template>
  </q-card>
...
export default {
  ...
  methods: {
    ...mapActions("christianLifePrayers", ["updateMeeting", "deleteMeeting"]),
    submitForm() {
      this.updateMeeting({
        id: this.id,
