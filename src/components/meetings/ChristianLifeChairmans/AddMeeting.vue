<template>
  <q-card>
    <q-card-section class="row">
      <div class="text-h6">Add Christian Life Meeting's Chairman</div>
      <q-space />
...
export default {
  ...
  computed: {
    ...mapGetters("publishers", {
      publishers: "christianLifeChairmans",
      numberOfPublishers: "numberOfChristianLifeChairmans"
    })
  },
  methods: {
    ...mapActions("christianLifeChairmans", ["addMeeting"])
  }
};
</script>
